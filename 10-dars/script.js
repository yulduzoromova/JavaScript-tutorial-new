...
console.log(str3.substring(2, 0));  // we, slice bn bir xil ishlidi faqat parametrlarga teskari qiymat yozsak ham o'zi to'girlab qirqib beradi masalab 2dan 0ga emas, odan 2gacha kesib beradi. Manfiy qiymat qabul qilmaydi

console.log(str3.substr(2, 2));  // bb,  2dan boshlab 2ta harfni kesib beradi yani 2-parametr nechta harf kesib ko'rsatadi. negative start qiymatni qabul qiladi. Faqat changa qarab emas onngga qarab yuradi. Manfiy qiymat ham qabul qiladi.
...
console.log(comp.trim().length);  // 8, trim() metodi o'sha bosh specelarni tashab yuborib stringni asl uzunligini chiqaradi. Ln 2ta so'zni o'rtasidagi bosh joylarni chiqarib tashamaydi

console.log(comp.trimStart());     //computer   stringni boshidagi spaceni o'chirib beradi
console.log(comp.trimEnd());      //   computer  stringni oxiridagi bo'sh spacelarni o'chirb beradi
...
console.log(comp.split(""));      // [
  ...
  console.log(comp.split(" ")); // parametrga qo'shtirnoq ichida probel tashasak, stringni qayerida space ko'rsa o'shani bitta array qilib oladi. 2-parametr qabul qiladi, 2=limit nechsa so'zni chiqarish kk shuni yozsak bo'ladi
  ...
  console.log(comp.replace("computer", "Computer")); // 2-parametrdagi so'zga o'zgartirib beradi. agar 1-par.dagi so'z noto'g'ri yozilgan bo'lsa, o'zgartirmaydi. /cOmputer/i deb yozgar ignore qilib aytilgan qiymatga o'zgartiradi. /cOmputer/ig qo'yilsa, Necta shunaqa so'z bo'lsa hammasini o'gartiradi
